  ...
  const result = jsonFilterRecursive(
    {
      ...
      disk: common?.disk ? { no: common.disk.no, of: common.disk.of } : undefined,
      track: common?.track ? { no: common.track.no, of: common.track.of } : undefined,
      ...
      albumsort: common?.albumsort,
      titlesort: common?.titlesort,
      work: common?.work,
      artistsort: common?.artistsort,
      albumartistsort: common?.albumartistsort,
      composersort: common?.composersort,
      ...
      longDescription: common?.longDescription,
      discsubtitle: common?.discsubtitle,
      totaltracks: common?.totaltracks,
      totaldiscs: common?.totaldiscs,
      movementTotal: common?.movementTotal,
      ...
      tvShow: common?.tvShow,
      tvShowSort: common?.tvShowSort,
      tvSeason: common?.tvSeason,
      tvEpisode: common?.tvEpisode,
      tvEpisodeId: common?.tvEpisodeId,
      tvNetwork: common?.tvNetwork,
      podcast: common?.podcast,
      podcasturl: common?.podcasturl,
      releasestatus: common?.releasestatus,
      ...
      encodersettings: common?.encodersettings,
      gapless: common?.gapless,
      barcode: common?.barcode,
      isrc: common?.isrc,
      asin: common?.asin,
      website: common?.website,
      performer_instrument: common?.performer_instrument,
      averageLevel: common?.averageLevel,
      peakLevel: common?.peakLevel,
      notes: common?.notes,
      originalalbum: common?.originalalbum,
      originalartist: common?.originalartist,
      key: common?.key,
      category: common?.category,
      hdVideo: common?.hdVideo,
      keywords: common?.keywords,
      movement: common?.movement,
      podcastId: common?.podcastId,
      showMovement: common?.showMovement,
      stik: common?.stik,
