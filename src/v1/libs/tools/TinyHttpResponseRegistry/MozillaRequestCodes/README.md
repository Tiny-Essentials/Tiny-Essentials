...
* **Data Content:** The JSON data itself contains documentation text extracted from [MDN Web Docs](https://mozilla.org) and is licensed under the **Creative Commons Attribution-ShareAlike 2.5 Generic (CC-BY-SA-2.5)**.
...
* The CC-BY-SA-2.5 *ShareAlike* clause applies **strictly and exclusively** to the JSON data and any direct modifications made to its text content. It does not extend to or affect the LGPL v3 source code.
